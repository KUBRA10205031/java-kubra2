...
public class C04_MathMethods {
  ...
  /*
    Math.abs(a)     ----->   Girilen degerin mutlak degerini verir.
...
/*TASK -> 81 sayısının karekökünü alalım -> windows-CTRL - mac- CMD */


        System.out.println("81'in karekök değeri:"+ Math.sqrt(81));// 9.0 ---> Math classına gidiyorum "." ile method getiriyorum.
        System.out.println("sayının mutlak değeri : " + Math.abs(-34));//34
